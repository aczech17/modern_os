...
def create_disk_image():
    ...
    with open("out/os.img", "wb") as img_file:
        ...
        with open("out/stage1.o", "rb") as stage1:
            img_file.write(stage1.read())
        with open("out/stage2.o", "rb") as stage2:
...
def main():
    ...
    # Assemble stage 2
    assemble_asm('src/stage2.asm', 'out/stage2.o')

    calculate_sectors(['out/stage2.o'])

    # Assemble stage 1
    assemble_asm('src/stage1.asm', 'out/stage1.o')
